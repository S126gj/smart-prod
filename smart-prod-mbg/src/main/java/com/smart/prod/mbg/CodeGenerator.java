...
public class CodeGenerator {
    ...
    private static final DataSourceConfig.Builder DATA_SOURCE_CONFIG = new DataSourceConfig.Builder(
        "jdbc:mysql://122.227.146.210:23306/data_acquisition?characterEncoding=UTF-8&useSSL=false&serverTimezone=Asia/Shanghai&allowPublicKeyRetrieval=true&stringtype=unspecified",
        "root",
        "123456"
    );
    ...
    public static void main(String[] args) {
        // 获取当前模块所在的路径
        String finalPath = String.format("%s/data-acquisition-core/src/main/java", System.getProperty("user.dir"));
        String xmlPath = String.format("%s/data-acquisition-core/src/main/java/com/data/acquisition/core/user/mapper/xml", System.getProperty("user.dir"));
        ...
        FastAutoGenerator.create(DATA_SOURCE_CONFIG)
                ...
                .packageConfig(builder -> {
                    builder.parent("com.smart.prod.core.user") // 设置父包名
                            .entity("entity")
                            .service("service")
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("box_run_hour_split") // 设置需要生成的表名
                            .addTablePrefix("sys_")
                            .build()
                            // 实体类配置
                            .entityBuilder()
