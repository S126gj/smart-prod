...
public class FileUtils {
    ...
    public static MultipartFile bufferedImageTransMultipartFile(BufferedImage image, String name, String originalFileName, String contentType) throws IOException {
        ByteArrayOutputStream bos = new ByteArrayOutputStream();
        // 将图像输出到输出流中。
        ImageIO.write(image, "jpeg", bos);
        MultipartFile multipartFile = new MockMultipartFile(name, originalFileName, contentType, bos.toByteArray());
