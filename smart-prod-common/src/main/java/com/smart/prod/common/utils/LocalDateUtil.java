...
public class LocalDateUtil extends LocalDateTimeUtil {
     ...
     * @return
     */
    public static String formatMMDDStr(LocalDate localDate){
        DateTimeFormatter df = DateTimeFormatter.ofPattern(Constanst.FORMAT_MMDD_STR);
        return df.format(localDate);
    }
     ...
     * @return
     */
    public static LocalDateTime getDateBegin(LocalDate date) {
     ...
     * @return
     */
    public static LocalDateTime getDateNextDayBegin(LocalDate date) {
